...
// AWSEC2InstanceBP provides the boilerplate for aws_instance
...
// AWSAMIBP provides the boilerplate for aws_ami
func AWSAMIBP() {
...
// AWSAMICopyBP provides the boilerplate for aws_ami_copy
func AWSAMICopyBP() {
	color.Green("\nresource \"aws_ami_copy\" \"example\" {\n  name              = \"terraform-example\"\n  description       = \"A copy of ami-xxxxxxxx\"\n  source_ami_id     = \"ami-xxxxxxxx\"\n  source_ami_region = \"us-west-1\"\n\n  tags = {\n    Name = \"HelloWorld\"\n  }\n}")
	color.Yellow("\nCheckout https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ami_copy\n\n")
}

// AWSAMIFromInstanceBP provides the boilerplate for aws_ami_from_instance
...
// AWSAMIFromLaunchPermissionBP provides the boilerplate for aws_ami_launch_permission
...
// AWSEBSDefaultKMSKeyBP provides the boilerplate for aws_ebs_default_kms_key
...
// AWSEBSEncryptionByDefaultBP provides the boilerplate for aws_ebs_encryption_by_default
...
// AWSEBSSnapshotBP provides the boilerplate for aws_ebs_snapshot
...
// AWSEBSSnapshotCopyBP provides the boilerplate for aws_ebs_snapshot_copy
...
// AWSEBSVolumeBP provides the boilerplate for aws_ebs_volume
func AWSEBSVolumeBP() {
	color.Green("\nresource \"aws_ebs_volume\" \"example\" {\n  availability_zone = \"us-west-2a\"\n  size              = 40\n\n  tags = {\n    Name = \"HelloWorld\"\n  }\n}")
	color.Yellow("\nCheckout https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ebs_volume\n\n")
}

// AWSEC2AvailabilityZoneGroupBP provides the boilerplate for aws_ec2_availability_zone_group
...
// AWSEC2CapacityReservationBP provides the boilerplate for aws_ec2_capacity_reservation
...
// AWSEC2CarrierGatewayPrompt provides the boilerplate for aws_ec2_carrier_gateway
...
// AWSEC2ClientVPNAuthorizationRuleBP provides the boilerplate for aws_ec2_client_vpn_authorization_rule
...
// AWSEC2ClientVPNEndpointBP provides the boilerplate for aws_ec2_client_vpn_endpoint
...
// AWSEC2ClientVPNNetworkAssociationBP provides the boilerplate for aws_ec2_client_vpn_network_association
...
// AWSEC2ClientVPNRouteBP provides the boilerplate for aws_ec2_client_vpn_route
...
// AWSEC2FleetBP provides the boilerplate for aws_ec2_fleet
func AWSEC2FleetBP() {
...
// AWSEC2LocalGatewayRouteBP provides the boilerplate for aws_ec2_local_gateway_route
...
// AWSEC2LocalGatewayRouteTableVPCAssociationBP provides the boilerplate for aws_ec2_local_gateway_route_table_vpc_association
...
// AWSEC2TagBP provides the boilerplate for aws_ec2_tag
func AWSEC2TagBP() {
...
// AWSEC2TrafficMirrorFilterBP provides the boilerplate for aws_ec2_traffic_mirror_filter
...
// AWSEC2TrafficMirrorFilterRuleBP provides the boilerplate for aws_ec2_traffic_mirror_filter_rule
...
// AWSEC2TrafficMirrorSessionBP provides the boilerplate for aws_ec2_traffic_mirror_session
...
// AWSEC2TrafficMirrorTargetBP provides the boilerplate for aws_ec2_traffic_mirror_target
...
// AWSEC2TransitGatewayBP provides the boilerplate for aws_ec2_transit_gateway
...
// AWSEC2TransitGatewayPeeringAttachmentBP provides the boilerplate for aws_ec2_transit_gateway_peering_attachment
...
// AWSEC2TransitGatewayPeeringAttachmentAccepterBP provides the boilerplate for aws_ec2_transit_gateway_peering_attachment_accepter
...
// AWSEC2TransitGatewayRouteBP provides the boilerplate for aws_ec2_transit_gateway_route
...
// AWSEC2TransitGatewayRouteTableBP provides the boilerplate for aws_ec2_transit_gateway_route_table
...
// AWSEC2TransitGatewayRouteTableAssociationBP provides the boilerplate for aws_ec2_transit_gateway_route_table_association
...
// AWSEC2TransitGatewayRouteTablePropagationBP provides the boilerplate for aws_ec2_transit_gateway_route_table_propagation
...
// AWSEC2TransitGatewayVPCAttachmentBP provides the boilerplate for aws_ec2_transit_gateway_vpc_attachment
...
// AWSEC2TransitGatewayVPCAttachmentAccepterBP provides the boilerplate for aws_ec2_transit_gateway_vpc_attachment_accepter
...
// AWSEIPBP provides the boilerplate for aws_eip
func AWSEIPBP() {
	color.Green("\nresource \"aws_eip\" \"lb\" {\n  instance = aws_instance.web.id\n  vpc      = true\n}")
	color.Yellow("\nCheckout https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/eip\n\n")
}

// AWSEIPAssociationBP provides the boilerplate for aws_eip_association
...
// AWSKeyPairBP provides the boilerplate for aws_key_pair
func AWSKeyPairBP() {
...
// AWSLaunchConfigurationBP provides the boilerplate for aws_launch_configuration
...
// AWSLaunchTemplateBP provides the boilerplate for aws_launch_template
...
// AWSPlacementGroupBP provides the boilerplate for aws_placement_group
...
// AWSSnapshotCreateVolumePermissionBP provides the boilerplate for aws_snapshot_create_volume_permission
...
// AWSSpotDatafeedSubscriptionBP provides the boilerplate for aws_spot_datafeed_subscription
...
// AWSSpotFleetRequestBP provides the boilerplate for aws_spot_fleet_request
...
// AWSSpotInstanceRequestBP provides the boilerplate for aws_spot_instance_request
...
// AWSVolumeAttachmentBP provides the boilerplate for aws_volume_attachment
